...
**Approximate validation performance** (same run as [`../../stage_05_evaluation_reports/results/training_metrics.csv`](../../stage_05_evaluation_reports/results/training_metrics.csv), epoch 200):
