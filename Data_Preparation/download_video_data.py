#!/usr/bin/env python3
"""
Video Data Download Script
Downloads video data from Windows path to Linux server
"""
...
"""
    ...
    script_path = Path("/mnt/storage5/Fruitfly/Data_Preparation/setup_download_tools.py")
    with open(script_path, 'w') as f:
        f.write(script)
...
def main():
    """Main function"""
    print("Setting up video data download tools...")
    print("=" * 50)
    ...
    print()
    print("To set up download tools, run:")
    print(f"python {setup_script}")
    print()
    print("This will create all necessary scripts and guides for downloading")
    print("video data from the Windows path to the server.")
